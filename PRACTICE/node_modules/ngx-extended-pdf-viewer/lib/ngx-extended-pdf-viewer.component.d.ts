...
export declare class NgxExtendedPdfViewerComponent implements OnInit, OnChanges, OnDestroy {
    ...
    private renderer;
    private pdfScriptLoaderService;
    ...
    constructor(ngZone: NgZone, platformId: any, notificationService: PDFNotificationService, elementRef: ElementRef, platformLocation: PlatformLocation, cdr: ChangeDetectorRef, service: NgxExtendedPdfViewerService, renderer: Renderer2, pdfScriptLoaderService: PDFScriptLoaderService, keyboardManager: NgxKeyboardManagerService);
    isIOS(): boolean;
